create schema if not exists summative_1_project;
use summative_1_projectconsole;
...
INSERT INTO `summative_1_project`.`processing_fee`(`product_type`, `fee`)
VALUES
('Conosle','14.99'),
('Game','1.49'),
('T-Shirt','1.98');
...
;
INSERT INTO `summative_1_project`.`sales_tax_rate` (`state`, `rate`) 
VALUES 
('AL', '.05'),
('AK', '.06'),
('AZ', '.04'),
